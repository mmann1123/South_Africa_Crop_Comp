...
of any model and among the lowest absolute scores. The same fate befalls the 3D CNN
...
\midrule
TabNet                & pixel & raw & 0.73 & $-0.13$ & \textbf{0.60} & \textbf{0.54} & \textbf{0.70} & \textbf{4.42} \\
...
Logistic Regression   & pixel & \texttt{xr\_fresh} & 0.61 & $\mathbf{-0.05}$ & 0.56 & 0.47 & 0.67 & 4.93 \\
...
(mean $-0.23$) and SMOTE-augmented stacking is similarly fragile ($-0.21$).
