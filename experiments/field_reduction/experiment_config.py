...
DISPLAY_NAME_MAP = {
    ...
    "ltae_sparse_field": "L-TAE-S Field (field)",
...
MODEL_FEATURE_TYPE = {
    ...
    "ltae_sparse_field": "raw temporal (field-averaged)",
...
MODEL_ENV_MAP = {
    ...
    "ltae_sparse_field": DEEP_FIELD_PYTHON,
...
MODEL_SCRIPT_MAP = {
    ...
    "ltae_sparse_field": os.path.join(EXPERIMENT_DIR, "train_ltae_sparse_field.py"),
