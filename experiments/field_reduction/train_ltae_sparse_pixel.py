"""Train L-TAE-S (pixel-level) with a reduced fraction of training fields.
...
Usage:
    python train_ltae_sparse_pixel.py --fraction 0.50 --output-dir models/ltae_sparse_pixel/frac_0.50
"""
...
def main():
    ...
    for seed in SEEDS_ENSEMBLE:
        ...
        best_val_f1 = 0.0
        patience_counter = 0
        model_path = os.path.join(args.output_dir, f"ltae_sparse_seed_{seed}.pt")
