"""Train TabNet (pixel-level) with a reduced fraction of training fields.

5-seed TabNetClassifier ensemble with averaged probabilities.
Field-level evaluation via majority vote.

Usage:
    python train_tabnet_pixel.py --fraction 0.50 --output-dir models/tabnet_pixel/frac_0.50
"""
...
def main():
    ...
    print(f"=== TabNet Pixel Training === Fraction: {fraction}")
    ...
    # Preprocess (matches TabTransformer_Final_Field.py)
    ...
    # Class weights for focal loss (recomputed from subsampled data)
